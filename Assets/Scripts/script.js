(function () {
  ...
  const food = class Food {
    ...
    addFood() {
      if (!this.ingredients || !this.marketWeight || !this.marketPrice || !this.grossWeight) return alert("Preencha os dados corretamente.");
